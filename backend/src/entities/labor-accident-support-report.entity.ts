...
@Entity('labor_accident_support_reports')
export class LaborAccidentSupportReport {
  @PrimaryGeneratedColumn()
  id!: number;
  ...
  @OneToOne(() => Report, (report) => report.laborAccidentSupportReport, {
    onDelete: 'CASCADE',
  })
  ...
  /**
   * =========================
   * MỤC 1: Tổng số tai nạn lao động và nạn nhân
   * =========================
   */
  @Column({ nullable: true })

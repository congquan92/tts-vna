                    ...
                    component={
                        <div className="flex gap-2 items-center">
                            ...
                            <input
                                ...
                                disabled={true}
                                className="w-16 border border-gray-200 rounded-lg px-2 py-1 text-xs text-center font-semibold outline-none focus:border-blue-500 bg-gray-100 cursor-not-allowed"
                            />
